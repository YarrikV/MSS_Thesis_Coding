...
The data are simulation using the EUHFORIA model which simulates the heliosphere between the Sun and Mars.
The data set contained a total of 27 simulations and had a size of more than 50 GB.
This large data set was processed using the Tecplot software.
...
- `tecplot_pytecplot`Files containing Pytecplot code. An "Euhforia_Run" class was written to analyse my data more efficiently.
