...
sys.path.append("/data/gent/440/vsc44090/euhforia_py2/coco")
sys.path.append("/data/gent/440/vsc44090/euhforia_py2/euhforia")
sys.path.append("/data/gent/440/vsc44090/euhforia_py2/euhforia/external/pyfishpack")
...
if __name__ == "__main__":
    ...
    for idx, f in enumerate(file_expressions):
        ...
        '''
        print leni, lenj, lenk
        print len(coordx), len(coordy), len(coordz)
        print len(data.vr[in_domain]), len(data.vr[in_domain][0]), len(data.vr[in_domain][0][0])
        print len(np.ndarray.flatten(data.vr[in_domain]))
        '''
